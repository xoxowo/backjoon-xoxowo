...
5(n) 는 바구니 개수, 4(m)는 넣으려는 공? 번호
4 (m)개의 줄에 걸쳐 공넣는 방법

1번 바구니에서 2번 바구니까지 3번 번호가 적혀있는 공을 넣는다는 뜻
3번 바구니에서 3번 바구니까지 4번 번호가 적혀있는 공을 넣는다
1 번바구니에서 4번바구니까지 1번 번호가 적혀있는 공을 넣음
2번 바구니에서 2번바구니까지 2번 번호가 적혀있는 공을 넣음
그러면 첫줄에 1번 바구니부터 4번 바구니까지 3번 공 넣음
1 2 3 4 바구니
3 3 3 3 공

두번째 줄에 3번~4번 바구니에 4번 공 넣음 
1 2 3 4
3 3 4 4 

세번째 줄 1번 ~ 4번 바구니에 1번 공 넣음
1 2 3 4
1 1 1 1

다시 마지막 2 번 바구니에 2번 공 넣음
1 2 3 4
1 2 1 1

각 바구니에 공 번호 출력하면 아래와같다 5번 바구니는 공을 안넣어서 0 개
1 2 1 1 0
